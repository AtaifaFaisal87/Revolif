...
const string EmailManager::SENDER_EMAIL = "yourgmail@gmail.com";
...
#ifdef _WIN32
    SetConsoleOutputCP(CP_UTF8); // make Windows console interpret output as UTF-8
    SetConsoleCP(CP_UTF8);       // (optional) also fix input codepage
#endif
